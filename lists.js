_global_audio_object = {
   ...
   locations: {
      ...
      'FillerGiveTeddybear.wav': {start: 96.02, length: 2.97},
      'FillerMakePencil.wav': {start: 98.69, length: 3.77},
      'FillerMakeSnowman.wav': {start: 102.45, length: 2.99},
      'FillerPutApples.wav': {start: 105.44, length: 3.66},
      'FillerSayCheese.wav': {start: 109.40, length: 3.4},
      ...
      'SmashRoosterNest.wav': {start: 190.75, length: 4.22},
  },
};
