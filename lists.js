_global_audio_object = {
   ...
   locations: {
      ...
      'CutCupcakeCandle.wav': {start: 13.56, length: 3.78},
      'CutCupcakeF.wav': {start: 18.84, length: 3.75},
      'CutGardenF.wav': {start: 22.59, length: 4.05},
      'CutGardenTree.wav': {start: 26.14, length: 4.33},
      ...
      'DryMonkeyBanana.wav': {start: 55.59, length: 4.2},
      'DryMonkeyF.wav': {start: 59.29, length: 3.88},
      'DryPillowDinosaur.wav': {start: 63.67, length: 4.17},
      ...
      'FillerAskTrain.wav': {start: 80.07, length: 3.21},
      'FillerBringPhone.wav': {start: 84.19, length: 3.23},
      'FillerCountStripes.wav': {start: 86.91, length: 3.04},
      'FillerFindOneWear.wav': {start: 90.44, length: 3.28},
      'FillerGetFlower.wav': {start: 91.22, length: 3.50},
      ...
      'FillerPutApples.wav': {start: 105.64, length: 3.46},
      'FillerSayCheese.wav': {start: 109.50, length: 3.4},
      'FillerShowBear.wav': {start: 113.29, length: 2.91},
      'FillerTellHorse.wav': {start: 115.90, length: 2.55},
      ...
      'KnockonWindowRainbow.wav': {start: 152.18, length: 4.43},
      ...
      'SmashPresentRibbon.wav': {start: 181.95, length: 4.18},
      'SmashRoosterF.wav': {start: 187.13, length: 3.83},
      'SmashRoosterNest.wav': {start: 190.15, length: 3.9},
  },
};
